...
Workflow aus den Anforderungen benötigt online-offline Anwendungen

Für die Erstellung von Offline-Applikationen, also Webanwendungen denen es möglich ist ohne eine Verbindung mit dem Internet zu funktionieren, gibt es zwei wichtige Technologien.
