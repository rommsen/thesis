...
Computergestütztes Lernen (E-Learning) bildet häufig die Wirklichkeit in Universitäten und anderen Bildungseinrichtungen ab. Dies hat eine sehr kursorientierte und institutszentrierten Sichtweise auf das Lernen zur Folge \cite{Mott2010}. Zur Umsetzung dessen werden zentralisierte Lern-Management-Systeme (LMS) eingesetzt, welche Lehrenden und Lernenden unterschiedliche Werkzeuge an die Hand geben. Den Lehrenden wird die Möglichkeit gegeben Kurse zur Erstellen und Informationen, Zeitpläne, Dateien und andere Ressourcen zu diesen Kursen hinzuzufügen. Der Lehrnende wird primär als Konsument aufgefasst. Er kann sich beispielsweise bei Kursen anmelden, Hausaufgaben einreichen und sich über Resultate informieren. Aktive Beteiligung ist ihm möglich, jedoch nur in dem von dem Lehrenden vorgebebenen Rahmen.

Diese zentralisierten und auf die Bildungseinrichtungen fokussierten Systeme haben jedoch mehrere Nachteile. Das Konzept des lebenslangen Lernens, wichtig. LMS Systeme können dies nicht erfüllen. Sie sind auf die aktuelle Bildungseinrichtung fixiert. Wechselt oder verlässt ein Nutzer beispielsweise die Universität, so hat er keinen Zugriff mehr auf die Werkzeuge, die ihm diese LMS zur Verfügung gestellt hat.

Es existieren unterschiedlichste Web-Services 

Attwell ist der Meinung, dass computergestützes Lernen in Zeiten des Internets und besonders von Web 2.0 nicht einfach nur die Formen des Lernens in Klassenräumen und Universitäten auf Software übertragen darf \cite{Attwell2007}. Die immer stärkere Nutzung von sozialen Netzwerken trägt dazu bei, dass die Nutzer sich von reinen Konsumenten hin zu einer Mischform von Konsumenten und Produzenten entwickelt haben. Diese Entwicklung müsse sich auch im Bereich des E-Learnings widerspiegelen. 

Die Idee von Personal Learnings Environments (PLEs) beschreibt eine Herangehensweise, wie mit diesen neuen Technologien umgegangen werden kann kann \cite{Attwell2007}. Sie nehmen Abstand von der kurs- oder institutszentrierten Sichtweise des computergestützten Lernens und propagieren eine nutzerzentrierte Sichtweise. Der Nutzer kann sich persönlich seine Werkzeuge, die er zum Lernen benötigt zusammenstellen und in einer Applikation zusammenfassen. Dies erlaubt es ihm diese auch bei sich veränderten Lebensumständen oder Lerngewohnheiten anzupassen und weiter zu benutzen. 


\subsection{Klassifizierungsmethoden für PLEs}
