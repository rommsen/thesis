...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{./Figures/plesynd_register_neu.png}
    \rule{35em}{0.5pt}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{./Figures/plesynd_workspace_online_neu.png}
    \rule{35em}{0.5pt}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{./Figures/plesynd_workspace_offline_neu.png}
    \rule{35em}{0.5pt}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{./Figures/plesynd_workspace_edit_neu.png}
    \rule{35em}{0.5pt}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{./Figures/plesynd_dashboard_neu.png}
    \rule{35em}{0.5pt}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{./Figures/plesynd_local_storage_neu.png}
    \rule{35em}{0.5pt}
