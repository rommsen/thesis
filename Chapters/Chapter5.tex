...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./Figures/konzeptionelle_loesung.pdf}
    \rule{35em}{0.5pt}
  \caption[Kozeptionelle Lösung]{Kozeptionelle Lösung}
  \label{fig:konzeptionelle_loesung}
\end{figure}
